                            ...
                            <div class="widget-content widget-content-area">
                                    <form method="post" action="{{route('image.update', 1)}} "enctype="multipart/form-data" >
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" name="text" class="form-control" id="h-text1" aria-describedby="h-text1" @if($image[0]['title'] == '' && $image[0]['text'] == '') value="{{old('text')}}"  @else value="{{$image[0]['text']}}" @endif>
                                        </div>
                                        @if($errors->has('text'))
