                        ...
                        <div id="creat" class="col-lg-12 col-12 layout-spacing" >
                            <div class="statbox widget box box-shadow" style="">
                                ...
                                <div class="widget-content widget-content-area simple-pills" >
                                  ...
                                  <form method="post" action="{{route('text.createNewText')}}" >
                                    @csrf
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a class="btn btn-primary" href="{{route('text.deleteTitle')}}">Да</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a class="btn btn-primary" href="{{route('text.deleteText', $item['id'])}}">Да</a>
                            </div>
                        </div>
                    </div>
                </div>
