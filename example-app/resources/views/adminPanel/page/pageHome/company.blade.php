...
@section('scriptAdd')
 ...
 <script src="{{asset('style/pageAdmin/assets/js/scrollspyNav.js')}}"></script>
    ...
    <script src="{{asset('style/js/range.js')}}"></script>
    @endsection
                         ...
                         <div class="row">
                                ...
                                <div class="col-lg-12 col-12 layout-spacing">
                                    <div class="statbox widget box box-shadow">
                                        ...
                                        <form method="post" action="{{route('company.updateСoverage')}}" class="">
                                            @csrf
                                            @if ($statistic[0]['procent'] == 0 && $statistic[1]['procent'] == 0)
                                            <div class="widget-content widget-content-area ">
                                                <div class="custom-progress bottom-right progress-down" style="width: 100%">
                                                    ...
                                                    <div class="range-count">
                                                        <span class="range-count-unit">Словения </span>
                                                        <span class="range-count-number" data-rangecountnumber="0">0</span>
                                                        <span class="range-count-unit">%</span>
                                                    </div>
                                                    <div class="range-count">
                                                        <span class="range-count-unit">Другие страны </span>
                                                        <span class="range-count-number result"></span>
                                                        <span class="range-count-unit">%</span>
                                                    </div>
                                            ...
                                            @else
                                                <div class="widget-content widget-content-area ">
                                                    <div class="custom-progress bottom-right progress-down" style="width: 100%">
                                                        <input name="procent" type="range" min="0" max="100" class="custom-range progress-range-counter" value="{{$statistic[0]['procent']}}">
                                                            <div class="range-count">
                                                                <span class="range-count-unit">Словения </span>
                                                                <span class="range-count-number" id="range" data-rangecountnumber="{{$statistic[0]['procent']}}">{{$statistic[0]['procent']}}</span>
                                                                <span class="range-count-unit">%</span>
                                                            </div>
                                                        <div class="range-count">
                                                            <span class="range-count-unit">Другие страны </span>
                                            ...
                                            <div class="widget-content widget-content-area">
                                                ...
                                                <form method="post" action="{{route('company.update')}}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" name="title" class="form-control" id="h-text1" aria-describedby="h-text1" value="{{$company[0]['title']}}">
                                                    </div>

                                                    <div class="form-group mb-4 mt-3">
                                                        <label for="exampleFormControlFile1">Текст</label>
                                                        <textarea name="text" style="min-height: 100px" class="form-control" id="exampleFormControlTextarea1" rows="3">{{$company[0]['titleLtext']}}</textarea>
                                                    </div>
