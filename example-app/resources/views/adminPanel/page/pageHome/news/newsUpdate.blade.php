                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <form method="post" action="{{route('news.update', $news['id'])}}"enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-4">
                                        <img width="100%" height="100%" src="{{asset('/storage/'.$news['image'])}}">
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="exampleFormControlInput2">Заголовок</label>
                                        <input type="text" name="title" class="form-control" id="h-text1" aria-describedby="h-text1" value="{{$news['title']}}">
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="exampleFormControlInput2">Подзаголовок</label>
                                        <input type="text" name="subtitle" class="form-control" id="h-text1" aria-describedby="h-text1"  value="{{$news['text']}}">
                                    </div>
                                    <div class="widget-content widget-content-area">
