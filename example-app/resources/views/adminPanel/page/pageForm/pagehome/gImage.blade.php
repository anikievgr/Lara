                                                ...
                                                <div class="widget-content widget-content-area">
                                                    <form method="post" action="{{route('image.update', 1)}} "enctype="multipart/form-data" >
                                                        ...
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <input type="text" name="title" class="form-control" id="h-text1" aria-describedby="h-text1" value="{{$image[0]['title']}}">
                                                        </div>
                                                        <div class="form-group mb-4">
                                                            <label for="exampleFormControlInput2">Подзоголовок</label>
                                                            <input type="text" name="text" class="form-control" id="h-text1" aria-describedby="h-text1" value="{{$image[0]['text']}}">
                                                        </div>
