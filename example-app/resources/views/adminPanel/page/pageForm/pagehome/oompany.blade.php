                         ...
                         <div class="row">
                            ...
                            <div class="col-lg-12 col-12 layout-spacing">
                                <div class="statbox widget box box-shadow">
                                    ...
                                    <form method="post" action="{{route('ocompany.store')}}" class="">
                                        @csrf
                                        @if ($procent == [])
                                            ...
                                            <div class="widget-content widget-content-area ">
                                                <div class="custom-progress bottom-right progress-down" style="width: 100%">
                                                    <input name="procent" type="range" min="0" max="100" class="custom-range progress-range-counter" value="{{$procent[0]['procent']}}">
                                                        <div class="range-count">
                                                            <span class="range-count-unit">Словения </span>
                                                            <span class="range-count-number" id="range" data-rangecountnumber="{{$procent[0]['procent']}}">{{$procent[0]['procent']}}</span>
                                                            <span class="range-count-unit">%</span>
                                                        </div>
                                                    <div class="range-count">
                                                        <span class="range-count-unit">Другие страны </span>
