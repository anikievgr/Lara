                                        ...
                                        <div class="statbox widget box box-shadow">
                                            ...
                                            <div class="widget-content widget-content-area simple-tab">
                                                ...
                                                <div class="tab-content" id="simpletabContent">
                                                    <div class="tab-pane fade show active" id="d{{$process[0]['id']}}"  role="tabpanel" aria-labelledby="home-tab">
                                                    ...
                                                    @foreach ($process->slice(1) as $item)
                                                        <div class="tab-pane fade show " id="d{{$item['id']}}" style="" role="tabpanel" aria-labelledby="home-tab">
