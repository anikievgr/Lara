...
@section('scriptAdd')
 <script src="{{asset('style/pageAdmin/plugins/apex/apexcharts.min.js')}}"></script>
            <script src="{{asset('style/pageAdmin/assets/js/dashboard/dash_1.js')}}"></script>
   @endsection
@section('content')
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-card-one">
                            <div class="widget-content">
                                ...
                                <div class="media">
                                    <div class="w-img">
                                        <img src="../style/pageAdmin/assets/img/90x90.jpg" alt="avatar">
                                    </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-card-two">
                            <div class="widget-content">
                                ...
                                <div class="media">
                                    <div class="w-img">
                                        <img src="../style/pageAdmin/assets/img/potion.svg" alt="avatar">
                                    </div>
                                    <div class="media-body">
